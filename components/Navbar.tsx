        ...
        font-titleFont flex items-center justify-between position-relative">
            ...
            <div className="hidden mdl:inline-flex items-center gap-7">
                <ul className="flex text-[13px] gap-7">
                    ...
                    <Link 
                    className="flex items-center gap-1 font-medium 
                    text-textDark hover:text-textGreen cursor-pointer 
                ...
                showMenu && (
                    ...
                    className="absolute mdl:hidden top-0 right-0 w-full h-screen bg-black
                        ...
                        <motion.div
                            ...
                            className="w-[80%] h-full scrollbarHide bg-[#112240] 
                                ...
                                <div className="flex flex-col py-20 text-base gap-10 items-center">
                                    <ul className="flex flex-col py-20 text-base gap-10 items-center">
                                        ...
                                        <a href="./assets/resume.pdf" target="_blank">
                                            ...
                                            className="px-9 py-3 mt-3 text-2xl rounded-md text-textGreen 
                                            text-[base] border border-textGreen hover:bg-hoverColor duration-300">
                                                Resume
                                            </motion.button>
                                        </a> 
                                        ...
                                        hover:text-textGreen cursor-pointer transition-all duration-300"
