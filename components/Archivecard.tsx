        ...
        <a href={link} target="_blank">
            ...
            transition-transform duration-300 group">
                <div className="flex justify-between items-center">
                    <TbFolderCode className="text-4xl text-textGreen"/>
                    <TbExternalLink className="text-4xl hover:text-textGreen"/>
                </div>
                <div>
                    <h2 className="text-xl font-titleFont font-semibold 
                    tracking-wide group-hover:text-textGreen">
                        {title}
                    </h2>
                    <p className="text-sm mt-3">
                        {des}
                    </p>
                    <ul className="text-xs mt-3 mdl:text-sm text-textDark flex items-center gap-2
