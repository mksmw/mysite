...
const Contact = () => {
    return (
        ...
        flex-col gap-4 items-center justify-center">
            ...
            <p className="font-titleFont text-lg text-textOrDark font-semibold flex 
            ...
            <a href="mailto:mksmw@protonmail.com">
                <button className="w-40 h-14 border border-textOrDark mt-6 
                font-titleFont text-sm text-textOrDark tracking-wider rounded-md 
