                    ...
                    <div className="flex flex-col xl:flex-row gap-6">
                        ...
                        target="_blank">
                            <div>
                                ...
                                hover:-translate-y-2 transition-transform duration-300 group"
                                    ...
                                    alt="projectOne"/>
                                {/*
                                <div className="absolute w-full h-full bg-textOrDark/40 rounded-lg
                        ...
                        items-end text-right xl:-ml-16 z-10">
                            ...
                            <p className="bg-[#3F608A] text-sm md:text-base p-2 md:p-6 rounded-md">
                                ...
                                It is powered by {" "} 
                                <span className="text-textOrDark">Swift and Ruby</span> 
                ...
                <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
                    <div className="flex flex-col xl:flex-row-reverse gap-6">
                        ...
                        items-end text-right z-10">
                            ...
                            <p className="bg-[#3F608A] text-sm md:text-base p-2 xl:-mr-16 md:p-6 rounded-md">
                            ...
                            <span className="text-textOrDark">C#</span> 
